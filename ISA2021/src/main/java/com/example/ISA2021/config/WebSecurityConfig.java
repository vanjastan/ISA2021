...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http
				...
				.antMatchers("/api/users/logged/{userId}").permitAll()
				.antMatchers("/api/users/edit").permitAll()
				.antMatchers("/api/users/{userId}/cancelRequest").permitAll()
				.antMatchers("/api/users/answerRequest").permitAll()
				.antMatchers("/api/users/allCancelRequests").permitAll()
